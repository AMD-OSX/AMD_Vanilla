...
### 語言（Languages）: [English](../README.md), [Russian](./README_RUS.md), 繁中（已選）, [Spanish](languages/README_ES.md), [Simplified Chinese](languages/README_CHS.md)
...
- [0xD81CF](https://github.com/0xD81CF), [doesprintfwork](https://github.com/doesprintfwork), [erikjara](https://github.com/erikjara) 和 [Sukka](https://github.com/SukkaW) - README 翻譯
